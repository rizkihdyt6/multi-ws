...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/myridwan/update/ipuk/install_up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/myridwan/update/ipuk/version_up)
...
serverV=$( curl -sS https://raw.githubusercontent.com/myridwan/update/ipuk/version_up)
if [ "$Isadmin" = "ON" ]; then
uis="${GREEN}Premium User$NC"
else
uis="${YELLOW}VIP Version$NC"
fi
...
echo -e "$COLOR1┌─────────────────────────────────────────────────┐$NC"
echo -e "$COLOR1│$NC Version     :${COLOR1} 1.2 New Version${NC}"
