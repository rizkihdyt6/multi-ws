...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/myridwan/multi-ws/ipuk/backup/rclone.conf"
...
wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/myridwan/multi-ws/ipuk/backup/logcleaner.sh" && chmod +x /usr/bin/cleaner
